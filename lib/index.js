...
const SETTINGS_NAMESPACE = SETTINGS_NS;
function installSettingsSection(owner, ns, schema, entry, hooks) {
	...
	owner.inject(["settings"], (scoped) => {
		...
		if (typeof settings.installSection !== "function") throw new Error("dsh-anyrouter: unsupported settings API; expected the legacy helper or rc.1 settings.installSection");
