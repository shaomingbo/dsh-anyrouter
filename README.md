...
```bash
npx --yes github:shaomingbo/dsh-anyrouter#v0.2.2
```
...
```bash
npx --yes github:shaomingbo/dsh-anyrouter#v0.2.2 status                    # is it installed?
npx --yes github:shaomingbo/dsh-anyrouter#v0.2.2 uninstall                 # idempotent removal
npx --yes github:shaomingbo/dsh-anyrouter#v0.2.2 --profile headless        # another profile
DSH_ANYROUTER_SOURCE=link:/path/to/checkout npx --yes github:shaomingbo/dsh-anyrouter#v0.2.2   # local source override
```
...
```bash
DSH_ANYROUTER_SOURCE=link:/absolute/path/to/checkout npx --yes github:shaomingbo/dsh-anyrouter#v0.2.2
```
